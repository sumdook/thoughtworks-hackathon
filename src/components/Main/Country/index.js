...
class Country extends Component{
    ...
    renderCarousel = () => {
        ...
        if(currentGenre){
            const movieList = this.props.util.countries[currentGenre];
    ...
    renderGenre = () => {
        if(Object.keys(this.props.movies).length){
            const GenreList = this.props.util.countries;
                ...
                return(
                    <Col span={6}>
                        ...
                        >
                            ...
                            <p>{this.props.util.countries[item].length} movies</p>
                        </Card>
                    </Col>
               ); 
            })
    ...
    render(){
        ...
        return(
            <div>
                <h1 className="text-header">Choose your <span className="text-span">country</span></h1>
                <Slider {...settings}>
                    {this.renderGenre()}
                </Slider>
